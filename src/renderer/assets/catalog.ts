import type { AnimalDef, ActionDef } from '../engine/types'
...
export const ANIMALS: AnimalDef[] = [
  {
    ...
    resolutions: [16, 32],
    layers: [
      { id: 'shadow', name: 'Shadow', zIndex: 0, anchor: { x: 0, y: 0 }, optional: true },
      { id: 'tail', name: 'Tail', zIndex: 1, anchor: { x: 0, y: 0 } },
      { id: 'body', name: 'Body', zIndex: 2, anchor: { x: 0, y: 0 } },
      { id: 'ears', name: 'Ears', zIndex: 3, anchor: { x: 0, y: 0 } },
      { id: 'front_arm', name: 'Front Arm', zIndex: 4, anchor: { x: 0, y: 0 } },
      { id: 'eyes', name: 'Eyes', zIndex: 5, anchor: { x: 0, y: 0 } },
      { id: 'mouth', name: 'Mouth', zIndex: 6, anchor: { x: 0, y: 0 } }
    ],
